...
def main() -> None:
    ...
    music = os.getenv("AUDIO_CAT_ID", "3000")
    books = os.getenv("BOOKS_CAT_ID", "7020")
    adult = os.getenv("ADULT_CAT_ID", "6000")
